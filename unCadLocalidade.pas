...
begin
  ...
  if MessageBox(fmPrincipal.Handle,
                PWideChar('Confirma a exclusão da localidade?'),
...
begin
  try
    ...
    Ordenacao := '|"Código":"N":"Asc."|;|"País":"S":"Asc."|;|"Unidade da Federação":"S":"Asc."|;|"Localidade":"S":"Asc."|;|"DDD":"N":"Asc."|';
...
begin
  try
    try
      ...
      // Configura a Grid.
      editaColunaGrid(1,'CDLOCALIDADE','Código',edNone,taRightJustify,40,true);
