object fmCadInvestimentoSaqueParcial: TfmCadInvestimentoSaqueParcial
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Investimento :: Saque Parcial'
  ClientHeight = 131
  ClientWidth = 324
  Color = clBtnFace
  ...
  object PanelCampos: TAdvPanel
    ...
    Styler = fmPrincipal.PanelStyler
    FullHeight = 141
    object EditCadastroValorSaque: TAdvMoneyEdit
      Tag = 3
      Left = 6
      Top = 35
      Width = 123
      Height = 21
      Hint = 'Valor do Saque no Investimento.'
      EditType = etMoney
      EmptyTextStyle = []
    ...
    object EditCadastroValorInvestimentoAtual: TAdvMoneyEdit
      Tag = 3
      Left = 6
      Top = 10
      Width = 123
      Height = 21
      Hint = 'Valor do investimento atual.'
      EditType = etMoney
      EmptyTextStyle = []
      DisabledColor = clWindow
      Precision = 2
